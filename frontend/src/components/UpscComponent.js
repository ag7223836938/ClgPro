                ...
                <div className="about">
                    <div className="container">
                        <div className="row about-text align-self-center">
                            <h3>About Exam</h3>
                            <p>The Civil Services Examination (CSE) is a National level competitive examination in India, conducted by the Union Public Service Commission (UPSC) for the recruitment to various Civil Services of the Government of India.</p>
                        </div>
                    </div>
                </div>
                <div className="motto">
